...
pub const move_cursor_to_col_fmt = "\x1B[{}G";
...
// NOTE: these have been removed in favor for a move and col set
// unlike move_cursor this sets the column to 0 after the move
//pub const move_cursor_down_line_fmt = "\x1B[{}E";
//pub const move_cursor_up_line_fmt = "\x1B[{}F";
